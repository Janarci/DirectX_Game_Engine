...
void DeviceContext::drawIndexTriangleList(UINT index_count, UINT start_vertex_index, UINT start_index_location)
{
	...
	//m_device_context->RSSetState(GraphicsEngine::get()->getRasterizerState());
...
void DeviceContext::setRasterizerState(RasterizerState* rasterizerState)
{
	m_device_context->RSSetState(rasterizerState->m_rs);
